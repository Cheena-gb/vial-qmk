...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
		JP_ZKHK, KC_ESC , KC_1,    KC_2,    KC_3,   KC_4,   KC_5,    KC_6,    KC_7,    KC_8,   KC_9,    KC_0,    JP_MINS, JP_CIRC, JP_YEN, KC_BSPC,
    	KC_NO,   KC_TAB,  KC_Q,    KC_W,    KC_E,   KC_R,   KC_T,    KC_Y,    KC_U,    KC_I,   KC_O,    KC_P,    JP_AT,   JP_LBRC, KC_ENT,
    	KC_NO,   KC_CAPS, KC_A,    KC_S,    KC_D,   KC_F,   KC_G,    KC_H,    KC_J,    KC_K,   KC_L,    JP_SCLN, JP_COLN, JP_RBRC, MO(_FN),
